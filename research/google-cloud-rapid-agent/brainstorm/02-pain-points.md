...
- **Why now (2026 timing):** 4,300+ active phishing domains *right now*,
...
- **Pain:** Per Unit21 / FraudOps reporting, queues of 400+ alerts per team
  ...
  ~6 hours per analyst. Bottleneck is *gathering evidence across systems*,
...
- **What an agent could do:** Given an alert ID, agent fetches all
  cross-system evidence, summarizes with citations, *drafts* the SAR
...
1. **Cross-language action-shaped voice in / action-out**: The same
   ...
   Wherever a non-English speaker needs the system to *do* something,
...
3. **Pre-check / pre-fill before human review**: 6.2 (permits), 2.2
   ...
   *pre-checks completeness + drafts the human's response* compresses
   the queue by 5–10×.
