...
| #   | Score | Project            | Gallery   | Why not a duplicate                                                                                                                                                                                         |
| --- | ----- | ------------------ | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | 0.062 | **Community Host** | ETHGlobal | _"AI agent. It plays a welcoming and assistive role, much like the concierge of a hotel."_ **Same persona shape (concierge-like agent)** — adjacent but not multilingual, not World Cup, not action-shaped. |
