"""Tests for `chaoslab_agent.adk_types` — quarantine + pydantic type-safety wrappers."""
...
def test_only_quarantine_imports_google_adk() -> None:
    """`adk_types.py` is the ONLY file under apps/chaoslab-agent/src/ that imports google.adk.
    ...
    src_dir = repo_root / "apps" / "chaoslab-agent" / "src" / "chaoslab_agent"
    ...
    assert listed == expected, (
        ...
        f"the symbol from `chaoslab_agent.adk_types`."
    )
...
def test_agent_spec_accepts_valid_payload() -> None:
    from chaoslab_agent.adk_types import AgentSpec
...
def test_run_state_accepts_valid_payload() -> None:
    from chaoslab_agent.adk_types import RunState
...
def test_run_event_accepts_valid_payload() -> None:
    from chaoslab_agent.adk_types import RunEvent
