...
from chaoslab_agent.judge.rubrics._base import PhoenixClient
...
class AnnotationWritebackError(RuntimeError):
    ...
    def __init__(
        ...
        super().__init__(
            f"Phoenix rejected {attempted_count} chaoslab_failure_cluster annotations: {cause!r}"
        )
...
async def write_annotations(
    ...
    try:
        ...
        logger.exception(
            "chaoslab_failure_cluster writeback failed",
            extra={
