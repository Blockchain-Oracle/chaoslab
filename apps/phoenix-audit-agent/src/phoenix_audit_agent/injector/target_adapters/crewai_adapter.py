...
from phoenix_audit_agent.injector.target_adapters._crewai_hook_proxy import crewai_hook_session
...
class CrewAIAdapter(TargetAdapter):
    ...
    async def invoke(self, invocation: AdapterInvocation) -> AdapterResult:
        ...
        async with crewai_hook_session(
            ...
            with _TRACER.start_as_current_span("phoenix-audit.adapter.crewai.invoke") as span:
