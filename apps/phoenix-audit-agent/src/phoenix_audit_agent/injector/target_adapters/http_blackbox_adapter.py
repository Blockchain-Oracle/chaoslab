...
from phoenix_audit_agent.injector.target_adapters._discovery import (
    DiscoveryResult,
    run_discovery_chain,
)
from phoenix_audit_agent.injector.target_adapters._fingerprint import behavioral_fingerprint
...
class HTTPBlackboxAdapter(TargetAdapter):
    ...
    async def invoke(self, invocation: AdapterInvocation) -> AdapterResult:
        ...
        with _TRACER.start_as_current_span("phoenix-audit.adapter.http_blackbox.invoke") as span:
