"""Structured logging + Phoenix OTel registration for phoenix-audit-agent.
...
def setup_phoenix_otel(settings: Settings) -> None:
    ...
    try:
        ...
        msg = (
            ...
            "Install via `uv add arize-phoenix-otel` in apps/phoenix-audit-agent/."
        )
