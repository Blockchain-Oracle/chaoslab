...
from phoenix_audit_agent.errors import PhoenixExperimentError
...
def test_experiment_result_accepts_valid_payload() -> None:
    from phoenix_audit_agent.phoenix_tools.run_experiment import ExperimentResult
...
def test_phoenix_run_experiment_tool_is_a_function_tool() -> None:
    ...
    from phoenix_audit_agent.phoenix_tools.run_experiment import phoenix_run_experiment_tool
...
def test_run_phoenix_experiment_body_is_within_adr_005_loc_budget() -> None:
    ...
    from phoenix_audit_agent.phoenix_tools.run_experiment import run_phoenix_experiment
...
def test_extract_result_raises_on_each_missing_required_attribute(missing_attr: str) -> None:
    ...
    """
    from phoenix_audit_agent.phoenix_tools.run_experiment import _extract_result
...
def test_scrub_secret_redacts_keyword_adjacent_tokens(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from phoenix_audit_agent.phoenix_tools.run_experiment import _scrub_secret
...
def test_derive_base_url_strips_trace_suffix(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from phoenix_audit_agent.phoenix_tools.run_experiment import _derive_base_url
