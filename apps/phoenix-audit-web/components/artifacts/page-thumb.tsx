...
interface PageThumbProps {
  ...
  signed: boolean
  onClick: () => void
  /** Real per-probe verdicts for the tests-page thumbnail squares. */
  testThumbs?: ReadonlyArray<'P' | 'F'>
}

const SCRIBBLE_LINES = [34, 90, 78, 84, 60, 88, 72] as const

export function PageThumb({ p, active, signed, onClick, testThumbs = [] }: PageThumbProps) {
  return (
    <button
      onClick={onClick}
      style={{
